...
class RunnerTest
{
    ...
    void isArrayPrimeRecur()
    {
        ...
        Assertions.assertFalse(Runner.isArrayPrimeRecur(testNumsFirst, testNumsFirst.length));
        Assertions.assertTrue(Runner.isArrayPrimeRecur(testNumsSecond, testNumsSecond.length));
    }
